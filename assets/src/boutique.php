            ...
            <h2>Fruits et légumes :</h2>
                <div class="carousel1">
                    <div class="carousel1-inner">
                        <div class="slide1">
                            <img src="téléchargement.jpg" alt="Image 1">
                        </div>
                        <div class="slide1">
                            <img src="téléchargement (1).jpg"alt="Image 2">
                        </div>
                        <div class="slide1">
                            <img src="téléchargement (2).jpg"alt="Image 3">
                        </div>
                    </div>
        ...
        <div class="container2">
            ...
            <div class="carousel2">
                    <div class="carousel2-inner">
                        <div class="slide2">
                            <img src="téléchargement (3).jpg"alt="Image 1">
                        </div>
                        <div class="slide2">
                            <img src="téléchargement (4).jpg"alt="Image 2">
                        </div>
                        <div class="slide2">
                            <img src="téléchargement (5).jpg"alt="Image 3">
                        </div>
                    </div>
                    <!-- Conteneur pour les boutons de navigation -->
